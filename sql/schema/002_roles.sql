...
DO $$
BEGIN
    CREATE ROLE portfell_data_loader NOLOGIN;
EXCEPTION
...
GRANT USAGE ON SCHEMA portfell_market TO portfell_data_loader, portfell_app;
REVOKE CREATE ON SCHEMA portfell_market FROM portfell_data_loader, portfell_app;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA portfell_market
    GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO portfell_data_loader;
ALTER DEFAULT PRIVILEGES IN SCHEMA portfell_market
