...
CREATE SCHEMA IF NOT EXISTS portfell_loader_sync;

CREATE TABLE IF NOT EXISTS portfell_loader_sync.sync_state (
...
CREATE TABLE IF NOT EXISTS portfell_loader_sync.loader_runs (
